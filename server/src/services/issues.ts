...
const ALL_ISSUE_STATUSES = ["backlog", "todo", "in_progress", "in_review", "blocked", "awaiting_human", "done", "cancelled"];
...
const issueListSelect = {
  ...
  originThreadId: issues.originThreadId,
  originThreadMessageId: issues.originThreadMessageId,
  ...
  async function buildIssueGraph(
    ...
    for (const row of artifactRows) {
      ...
      deliverableNodes.push({
        ...
        companyId: row.companyId,
        issueId: row.issueId,
        originatingIssueId: rootRow.id,
        originatingIssueIdentifier: rootRow.identifier,
        originatingIssueTitle: rootRow.title,
